...
export const MovieCard = ({ movie, selectedMovieIds, onSelectMovie }: MovieCardProps) => {
  ...
  return (
    <div className="relative h-full group-hover/slide:z-30">
      <div className="h-full w-full transition-all duration-300 ease-in-out transform-gpu group-hover/slide:scale-125 group-hover/slide:shadow-2xl group-hover/slide:shadow-primary/10">
