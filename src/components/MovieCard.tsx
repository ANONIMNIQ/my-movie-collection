  ...
  return (
    ...
    >
      ...
      <Link to={`/movie/${movie.id}`} className="block h-full">
        <Card className="h-full flex flex-col bg-card border-none rounded-none"> {/* Removed overflow-hidden */}
          {isAdmin && (
          ...
          {/* Hover Overlay */}
          {isHovered && (
            <div className="absolute inset-0 flex flex-col transition-opacity duration-300 z-20 rounded-none"> {/* Removed overflow-hidden */}
